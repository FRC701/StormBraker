...
OI::OI() {
    ...
    frc::SmartDashboard::PutData("Intake On", new SetIntake(1));
    frc::SmartDashboard::PutData("Intake Off", new SetIntake(0));
    frc::SmartDashboard::PutData("Out Take", new SetIntake(-1));
