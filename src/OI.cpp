...
, coSelect(coDriver.get(), kButtonSelect_ID)
{
    ...
    SmartDashboard::PutData("Arm Forward", new ArmMove(1));
    SmartDashboard::PutData("Arm Backward", new ArmMove(-1));
    ...
    SmartDashboard::PutData("IntakeIn", new SetIntake(0.5));
    SmartDashboard::PutData("IntakeOut", new SetIntake(-0.5));
